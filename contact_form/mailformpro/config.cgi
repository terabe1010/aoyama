...
## フォームの宛先
push @mailto,'camp-aoyama@zd.ztv.ne.jp';

## 管理者宛メールのCC・BCCの宛先
#$config{'admin_cc'} = 'camp-aoyama@zd.ztv.ne.jp';
#$config{'admin_bcc'} = 'camp-aoyama@zd.ztv.ne.jp';

## 自動返信メールのCC・BCCの宛先
#$config{'responder_cc'} = 'camp-aoyama@zd.ztv.ne.jp';
#$config{'responder_bcc'} = 'camp-aoyama@zd.ztv.ne.jp';

## 自動返信メールの差出人名
$config{'fromname'} = '青山高原保健休養地';
...
〒515-2614 三重県津市白山町伊勢見4番地
 TEL：059-269-3226 FAX： 059-269-3276
 Email：camp-aoyama@zd.ztv.ne.jp
 URL: https://www.aoyama-hoyochi.co.jp
◇◇◇◇◇◇◇◇◇◇◇◇◇◇◇◇◇◇◇◇◇
__posted_body__
